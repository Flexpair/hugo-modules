...
use this new version instead <https://github.com/Flexpair/hugo-modules/tree/master/shortcodes/button>
...
```toml
[[imports]]
path = "github.com/Flexpair/hugo-modules/shortcodes/buttons"
```
