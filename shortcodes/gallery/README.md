...
use this new version instead <https://github.com/Flexpair/hugo-modules/tree/master/gallery-slider>
...
```toml
[[imports]]
path = "github.com/Flexpair/hugo-modules/shortcodes/gallery"
```
